...
class Post(models.Model): # classe criada passando como argumento o Model de models, que já tem campos pré-definidos
    ...
    author = models.ForeignKey(User, on_delete=models.CASCADE, related_name='blog_posts') # autor
    ...
    status = models.IntegerField(choices=STATUS, default=0) # se está como rascunho ou publicado
